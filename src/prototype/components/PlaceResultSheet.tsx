...
const styles = StyleSheet.create({
  sheet: {
    ...
    boxShadow: '0px -6px 20px rgba(25, 31, 40, 0.16)',
    zIndex: 10,
    overflow: 'hidden',
  },
  handleArea: { alignItems: 'center', paddingTop: 8, paddingBottom: 4 },
  handle: { width: 40, height: 5, borderRadius: 3, backgroundColor: colors.surfaceStrong },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  actionDone: { backgroundColor: colors.surface, borderColor: 'transparent' },
